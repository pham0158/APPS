...
<div class="stem-master-panel" id="stemMasterPanel">
  ...
  <div class="stem-master-body">
    ...
    <div class="spectrum-wrap">
      ...
      <div class="exp-sl-row"><span class="exp-sl-lbl">Low Shelf</span><input type="range" class="stem-slider" data-p="eq.bass" min="-12" max="12" step=".5" value="${e.eq.bass}" style="--stem-color:${t}"><span class="exp-sl-val" data-v="eq.bass">${ee(e.eq.bass)}</span></div>
      <div class="exp-sl-row"><span class="exp-sl-lbl">Presence</span><input type="range" class="stem-slider" data-p="eq.pres" min="-12" max="12" step=".5" value="${e.eq.pres}" style="--stem-color:${t}"><span class="exp-sl-val" data-v="eq.pres">${ee(e.eq.pres)}</span></div>
      <div class="exp-sl-row"><span class="exp-sl-lbl">Hi Shelf</span><input type="range" class="stem-slider" data-p="eq.air" min="-12" max="12" step=".5" value="${e.eq.air}" style="--stem-color:${t}"><span class="exp-sl-val" data-v="eq.air">${ee(e.eq.air)}</span></div>`,a=`
      ...
      <div class="exp-sl-row"><span class="exp-sl-lbl">Ratio</span><input type="range" class="stem-slider" data-p="comp.rat" min="1" max="20" step=".5" value="${e.comp.rat}" style="--stem-color:${t}"><span class="exp-sl-val" data-v="comp.rat">${Oe(e.comp.rat)}</span></div>
      <div class="exp-sl-row"><span class="exp-sl-lbl">Attack</span><input type="range" class="stem-slider" data-p="comp.atk" min=".1" max="200" step=".1" value="${e.comp.atk}" style="--stem-color:${t}"><span class="exp-sl-val" data-v="comp.atk">${ce(e.comp.atk)}</span></div>
      <div class="exp-sl-row"><span class="exp-sl-lbl">Release</span><input type="range" class="stem-slider" data-p="comp.rel" min="10" max="1000" step="5" value="${e.comp.rel}" style="--stem-color:${t}"><span class="exp-sl-val" data-v="comp.rel">${ce(e.comp.rel)}</span></div>`;return`
    <div class="track-hdr">
      <span class="t-icon">${Te[e.type]}</span>
      <div class="track-name-col">
        <div class="track-name" style="color:${t}">${e.name}</div>
        <div class="track-file">${e.filename} · ${We(e.fileSize)}</div>
      </div>
    ...
    <div class="track-mix">
      ...
      <div class="mix-pan">
        ...
        <span class="pan-num" data-v="pan">${He(e.pan)}</span>
      </div>
  ...
  `)}function Xe(){Ke(),new we().render(),new be().render();const t=new ye,s=new Pe(t),a=s.render(),i=document.getElementById("tab-master");i.innerHTML="",i.appendChild(a),s.init();const n=new Ze(t),l=n.render(),r=document.getElementById("tab-stem");r.innerHTML="",r.appendChild(l),n.init()}document.addEventListener("DOMContentLoaded",Xe);
