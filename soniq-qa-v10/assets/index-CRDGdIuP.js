...
`;class ke{constructor(){this._panel=null}render(){var t,s,a,i;const e=document.createElement("div");for(e.innerHTML=be.trim();e.firstChild;)document.body.appendChild(e.firstChild);this._panel=document.getElementById("helpPanel"),(t=document.getElementById("helpClose"))==null||t.addEventListener("click",()=>this.close()),(s=this._panel)==null||s.addEventListener("click",n=>{n.target===this._panel&&this.close()}),document.addEventListener("keydown",n=>{if(n.key==="Escape"){this.close();return}n.target.tagName==="INPUT"||n.target.tagName==="TEXTAREA"||(n.key==="h"||n.key==="H")&&this.toggle()}),(a=document.getElementById("helpBtn"))==null||a.addEventListener("click",()=>this.open()),(i=document.getElementById("helpSearch"))==null||i.addEventListener("input",n=>{var r;const l=n.target.value.trim().toLowerCase();(r=this._panel)==null||r.querySelectorAll(".help-control-item").forEach(o=>{var p,m;const d=((p=o.querySelector(".help-ctrl-name"))==null?void 0:p.textContent.toLowerCase())||"",h=((m=o.querySelector(".help-ctrl-desc"))==null?void 0:m.textContent.toLowerCase())||"",u=o.dataset.search||"";o.hidden=l.length>0&&!d.includes(l)&&!h.includes(l)&&!u.includes(l)})})}open(){var e,t;(e=this._panel)==null||e.classList.add("open"),(t=document.getElementById("helpSearch"))==null||t.focus()}close(){var e;(e=this._panel)==null||e.classList.remove("open")}toggle(){var e;(e=this._panel)!=null&&e.classList.contains("open")?this.close():this.open()}addTooltip(e,t){!e||!t||(e.dataset.tip=t,e.addEventListener("mouseenter",()=>{const s=document.getElementById("tipBubble");s&&(s.textContent=t,s.classList.add("visible"))}),e.addEventListener("mouseleave",()=>{var s;(s=document.getElementById("tipBubble"))==null||s.classList.remove("visible")}),e.addEventListener("mousemove",s=>{const a=document.getElementById("tipBubble");a&&(a.style.left=s.clientX+12+"px",a.style.top=s.clientY-8+"px")}))}addAllTooltips(e){e&&e.querySelectorAll("[data-tip]").forEach(t=>{this.addTooltip(t,t.dataset.tip)})}}class se{constructor(e,t){this._canvasId=e,this._color=t||"#6c63ff"}get canvas(){return document.getElementById(this._canvasId)}draw(e){const t=this.canvas;if(!t||!e)return;t.width=t.offsetWidth||600,t.height=80;const s=t.getContext("2d"),a=t.width,i=t.height,n=this._color;this._color+"";const l=parseInt(n.slice(1,3),16),r=parseInt(n.slice(3,5),16),o=parseInt(n.slice(5,7),16),d=`rgba(${l},${r},${o},0.12)`;s.fillStyle="#0d0d15",s.fillRect(0,0,a,i);const h=e.numberOfChannels,u=e.getChannelData(0),p=h>1?e.getChannelData(1):null,m=u.length,v=m/a,_=new Float32Array(a),y=new Float32Array(a);for(let f=0;f<a;f++){const b=Math.floor(f*v),x=Math.min(Math.floor((f+1)*v),m);let T=0,I=0;for(let D=b;D<x;D++){const g=p?(u[D]+p[D])*.5:u[D];g<T&&(T=g),g>I&&(I=g)}_[f]=i/2-I*(i/2-2),y[f]=i/2-T*(i/2-2)}s.beginPath(),s.moveTo(0,_[0]);for(let f=1;f<a;f++)s.lineTo(f,_[f]);for(let f=a-1;f>=0;f--)s.lineTo(f,y[f]);s.closePath(),s.fillStyle=d,s.fill(),s.beginPath(),s.moveTo(0,_[0]);for(let f=1;f<a;f++)s.lineTo(f,_[f]);s.strokeStyle=n,s.lineWidth=1.5,s.stroke(),s.beginPath(),s.moveTo(0,i/2),s.lineTo(a,i/2),s.strokeStyle="rgba(255,255,255,0.04)",s.lineWidth=1,s.stroke()}drawPlayhead(e){const t=this.canvas;if(!t)return;const s=t.getContext("2d"),a=Math.round(e*t.width);s.save(),s.strokeStyle="rgba(255,255,255,0.6)",s.lineWidth=1,s.beginPath(),s.moveTo(a,0),s.lineTo(a,t.height),s.stroke(),s.restore()}clear(){const e=this.canvas;if(!e)return;e.width=e.offsetWidth||600,e.height=80;const t=e.getContext("2d");t.fillStyle="#0d0d15",t.fillRect(0,0,e.width,e.height)}}class we{constructor(e){this._canvasId=e,this._rafId=null,this._sampleRate=44100}get canvas(){return document.getElementById(this._canvasId)}clear(){const e=this.canvas;if(!e)return;e.width=e.offsetWidth||800,e.height=100;const t=e.getContext("2d"),s=e.width,a=e.height;t.fillStyle="#0d0d15",t.fillRect(0,0,s,a),t.strokeStyle="#1a1a2e",t.lineWidth=1;for(let n=0;n<=4;n++){const l=n/4*a;t.beginPath(),t.moveTo(0,l),t.lineTo(s,l),t.stroke()}const i=document.getElementById("spectrumMsg");i&&(i.style.display="")}start(e){this.stop(),this._sampleRate=e.context.sampleRate;const t=this.canvas;if(!t)return;const s=new Float32Array(e.frequencyBinCount),a=document.getElementById("spectrumMsg");a&&(a.style.display="none");const i=()=>{this._rafId=requestAnimationFrame(i),e.getFloatFrequencyData(s);const n=t.offsetWidth||800;t.width=n;const l=t.height,r=t.getContext("2d");r.fillStyle="#0d0d15",r.fillRect(0,0,n,l),r.strokeStyle="#1a1a2e",r.lineWidth=1;for(let v=0;v<=4;v++){const _=v/4*l;r.beginPath(),r.moveTo(0,_),r.lineTo(n,_),r.stroke()}const o=this._sampleRate/2,d=s.length,h=Math.log10(20),u=Math.log10(2e4),p=Math.min(n,300),m=n/p;for(let v=0;v<p;v++){const _=Math.pow(10,h+v/p*(u-h)),y=Math.min(Math.floor(_/o*d),d-1),f=s[y],b=Math.max(0,(f+90)/90),x=b*l,T=v*m;let I;_<250?I=`rgba(108,99,255,${.7+b*.3})`:_<4e3?I=`rgba(0,212,170,${.7+b*.3})`:I=`rgba(180,220,255,${.6+b*.4})`,r.fillStyle=I,r.fillRect(T,l-x,Math.max(1,m-1),x)}};i()}stop(){this._rafId&&(cancelAnimationFrame(this._rafId),this._rafId=null),this.clear()}}class qe{constructor(){this._rafId=null,this._peakDecayL=0,this._peakDecayR=0,this._lufsHistory=[],this._histLen=15}update(e){const{integrated:t,shortTerm:s,lra:a,truePeak:i}=e;this._setText("lufsIntegrated",(t==null?void 0:t.toFixed(1))??"—"),this._setText("lufsLRA",(a==null?void 0:a.toFixed(1))??"—"),this._setText("lufsTruePeak",(i==null?void 0:i.toFixed(1))??"—");const n=document.getElementById("lufsShortTerm");if(n&&(n.textContent=s!=null&&isFinite(s)?s.toFixed(1):"—",n.className="lufs-number",s>-10?n.classList.add("hot"):s>-14?n.classList.add("warn"):n.classList.add("good")),s!=null){const l=Math.max(0,Math.min(100,(s+30)/24*100)),r=document.getElementById("lufsBarFill");r&&(r.style.width=l+"%")}}startMonitoring(e,t,s){this.stopMonitoring();const a=new Float32Array(e.fftSize);this._lufsHistory=[];const i=t?new Float32Array(t.fftSize):null,n=s?new Float32Array(s.fftSize):null,l=()=>{this._rafId=requestAnimationFrame(l),e.getFloatTimeDomainData(a);let r=0;for(let v=0;v<a.length;v++)r+=a[v]*a[v];const o=Math.sqrt(r/a.length),d=-.691+10*Math.log10(Math.max(o*o,1e-10));this._lufsHistory.push(d),this._lufsHistory.length>this._histLen&&this._lufsHistory.shift();const h=this._lufsHistory.reduce((v,_)=>v+_,0)/this._lufsHistory.length,u=document.getElementById("lufsShortTerm");u&&(u.textContent=isFinite(h)?h.toFixed(1):"—",u.className="lufs-number",h>-10?u.classList.add("hot"):h>-14?u.classList.add("warn"):u.classList.add("good"));const p=Math.max(0,Math.min(100,(h+30)/24*100)),m=document.getElementById("lufsBarFill");if(m&&(m.style.width=p+"%"),t&&i){t.getFloatTimeDomainData(i);let v=0;for(let y=0;y<i.length;y++){const f=Math.abs(i[y]);f>v&&(v=f)}this._peakDecayL=Math.max(v,this._peakDecayL*.88);const _=document.getElementById("peakL");_&&(_.style.height=Math.min(100,this._peakDecayL*130)+"%")}if(s&&n){s.getFloatTimeDomainData(n);let v=0;for(let y=0;y<n.length;y++){const f=Math.abs(n[y]);f>v&&(v=f)}this._peakDecayR=Math.max(v,this._peakDecayR*.88);const _=document.getElementById("peakR");_&&(_.style.height=Math.min(100,this._peakDecayR*130)+"%")}};l()}stopMonitoring(){this._rafId&&(cancelAnimationFrame(this._rafId),this._rafId=null),this._lufsHistory=[],this._peakDecayL=0,this._peakDecayR=0}reset(){this.stopMonitoring(),["lufsIntegrated","lufsShortTerm","lufsLRA","lufsTruePeak"].forEach(a=>{const i=document.getElementById(a);i&&(i.textContent="—",i.className="lufs-number")});const e=document.getElementById("lufsBarFill");e&&(e.style.width="0%");const t=document.getElementById("peakL"),s=document.getElementById("peakR");t&&(t.style.height="0%"),s&&(s.style.height="0%")}_setText(e,t){const s=document.getElementById(e);s&&(s.textContent=t)}}function Q(c){(!isFinite(c)||c<0)&&(c=0),c=Math.floor(c);const e=Math.floor(c/3600),t=Math.floor(c%3600/60),s=c%60;return e>0?`${e}:${t.toString().padStart(2,"0")}:${s.toString().padStart(2,"0")}`:`${t}:${s.toString().padStart(2,"0")}`}function Ee(c){return c=parseFloat(c),`${c>0?"+":""}${c.toFixed(1)} dB`}function oe(c){return`${parseFloat(c)}:1`}function O(c){return`${Math.round(c)}%`}function ce(c){return`${parseFloat(c)} ms`}function xe(c){return c=parseInt(c),c===0?"C":c>0?`R${c}`:`L${Math.abs(c)}`}function Be(c){return`${parseInt(c)} Hz`}function Z(c,e){return c==="volume"?O(e):c==="pan"?xe(e):c==="reverb"||c==="width"?O(e):c==="eq.hpf"?Be(e):c==="eq.bass"||c==="eq.pres"||c==="eq.air"?Ee(e):c==="comp.thr"?`${e} dB`:c==="comp.rat"?oe(e):c==="comp.atk"||c==="comp.rel"?ce(e):c==="humanizeIntensity"?O(e):String(e)}function Se(c,e){return e=parseFloat(e),c==="eq-demud"?O(e):c==="comp-ratio"?oe(e):c==="comp-attack"||c==="comp-release"?ce(e):c==="stereo-width"?O(e):`${e>0?"+":""}${e} dB`}function ae(c){return Math.pow(10,c/20)}class Me{constructor(e){this._onSeek=e||null,this._duration=0,this._rafId=null,this._dragging=!1,this._wasPlaying=!1,this._container=null,this._input=null,this._curEl=null,this._durEl=null}render({containerId:e,inputId:t,curId:s,durId:a}){this._container=document.getElementById(e),this._input=document.getElementById(t),this._curEl=document.getElementById(s),this._durEl=document.getElementById(a),this._input&&(this._input.addEventListener("pointerdown",()=>{this._dragging=!0,this._wasPlaying=!1,this._onSeek&&this._onSeek(-1)}),this._input.addEventListener("input",()=>{if(!this._duration)return;const i=this._input.value/1e3,n=i*this._duration;this._curEl&&(this._curEl.textContent=Q(n)),this._setFill(i*100)}),this._input.addEventListener("pointerup",()=>this._endDrag()),this._input.addEventListener("touchend",()=>this._endDrag()))}_endDrag(){if(!this._dragging||(this._dragging=!1,!this._duration))return;const t=this._input.value/1e3*this._duration;this._onSeek&&this._onSeek(t)}update(e,t){if(this._dragging||!this._input)return;this._duration=t;const s=t>0?Math.max(0,Math.min(1,e/t)):0;this._input.value=Math.round(s*1e3),this._setFill(s*100),this._curEl&&(this._curEl.textContent=Q(e))}setDuration(e){this._duration=e,this._durEl&&(this._durEl.textContent=Q(e)),this._container&&(this._container.style.display="")}reset(){this.stopAnimation(),this._input&&(this._input.value=0,this._setFill(0)),this._curEl&&(this._curEl.textContent=Q(0)),this._duration=0,this._container&&(this._container.style.display="none")}startAnimation(e){this.stopAnimation();const t=()=>{this._rafId=requestAnimationFrame(t),!this._dragging&&this.update(e(),this._duration)};t()}stopAnimation(){this._rafId&&(cancelAnimationFrame(this._rafId),this._rafId=null)}_setFill(e){this._input&&(this._input.style.background=`linear-gradient(to right, var(--accent) ${e}%, var(--knob-track) ${e}%)`)}}const Y={vocalBoost:{"eq-sub":0,"eq-bass":-2,"eq-mid":-3,"eq-highs":4,"eq-presence":8,"eq-air":5,"eq-demud":50,"comp-threshold":-20,"comp-ratio":10,"comp-attack":10,"comp-release":150,"stereo-width":100,"output-gain":0,toggles:{denoise:!0,limiter:!0,gate:!1}},hiFiMaster:{"eq-sub":2,"eq-bass":2,"eq-mid":0,"eq-highs":5,"eq-presence":5,"eq-air":7,"eq-demud":30,"comp-threshold":-18,"comp-ratio":4,"comp-attack":15,"comp-release":200,"stereo-width":150,"output-gain":0,toggles:{denoise:!1,limiter:!0,gate:!1}},warmth:{"eq-sub":4,"eq-bass":5,"eq-mid":1,"eq-highs":-1,"eq-presence":2,"eq-air":1,"eq-demud":20,"comp-threshold":-18,"comp-ratio":8,"comp-attack":25,"comp-release":250,"stereo-width":100,"output-gain":0,toggles:{denoise:!1,limiter:!0,gate:!1}},broadcast:{"eq-sub":0,"eq-bass":0,"eq-mid":-2,"eq-highs":3,"eq-presence":6,"eq-air":4,"eq-demud":60,"comp-threshold":-18,"comp-ratio":14,"comp-attack":5,"comp-release":100,"stereo-width":100,"output-gain":0,toggles:{denoise:!1,limiter:!0,gate:!1}},maxClarity:{"eq-sub":0,"eq-bass":-1,"eq-mid":-4,"eq-highs":6,"eq-presence":10,"eq-air":8,"eq-demud":70,"comp-threshold":-18,"comp-ratio":5,"comp-attack":10,"comp-release":150,"stereo-width":160,"output-gain":0,toggles:{denoise:!1,limiter:!0,gate:!1}}};class Le{constructor(e){this._onPresetSelect=e||null,this._active=null}render(){document.querySelectorAll(".preset-btn").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.preset;!t||!Y[t]||(this.setActive(t),this._onPresetSelect&&this._onPresetSelect(t,Y[t]))})}),this._syncButtons()}setActive(e){this._active=e,this._syncButtons()}clearActive(){this._active=null,this._syncButtons()}get active(){return this._active}_syncButtons(){document.querySelectorAll(".preset-btn").forEach(e=>{e.classList.toggle("active",e.dataset.preset===this._active)})}}class Ie{constructor(e){this._onReset=e||null}addResetButton(e,t){e&&e.addEventListener("click",()=>{this._onReset&&this._onReset(t,e),this.showConfirmation(e)})}addResetButtonById(e,t){const s=document.getElementById(e);this.addResetButton(s,t)}showConfirmation(e){if(!e)return;const t=e.textContent,s=e.style.color,a=e.style.borderColor;e.textContent="✓ Reset",e.style.color="var(--accent-2)",e.style.borderColor="var(--accent-2)",setTimeout(()=>{e.textContent=t,e.style.color=s,e.style.borderColor=a},1500)}}const K="https://cdn.jsdelivr.net/npm/@jitsi/rnnoise-wasm@0.0.1/dist/rnnoise.js",Ae="https://cdn.jsdelivr.net/npm/@jitsi/rnnoise-wasm@0.0.1/dist/rnnoise.wasm",ie=16e3,R=480,ne=32768;class de{constructor(){this._module=null,this._loaded=!1,this._available=!1,this._loading=!1}get isLoaded(){return this._loaded}get isAvailable(){return this._available}get isLoading(){return this._loading}async load(){if(!(this._loaded||this._loading)){this._loading=!0;try{await this._loadScript(K);const e=["createRNNoise","RNNoiseModule","Module","createModule"];let t=null;for(const s of e)if(typeof window[s]=="function"){t=window[s];break}if(!t)try{const s=await import(K);t=s.default||s.createRNNoise||s.Module}catch{}if(typeof t!="function")throw new Error("RNNoise factory not found");if(this._module=await t({locateFile:s=>s.endsWith(".wasm")?Ae:K.replace("rnnoise.js",s)}),typeof this._module._rnnoise_create!="function")throw new Error("RNNoise C API not found in module");this._loaded=!0,this._available=!0,this._loading=!1,console.info("[Denoise] RNNoise WASM ready")}catch(e){console.warn("[Denoise] RNNoise unavailable:",e.message),this._loaded=!1,this._available=!1,this._loading=!1,this._module=null}}}async process(e,t,s){return this._available&&this._module?this._processRNNoise(e,t,s):this._processWiener(e,t)}async _resample(e,t,s){if(e.sampleRate===t)return e;const a=Math.round(e.length*t/e.sampleRate),i=new OfflineAudioContext(e.numberOfChannels,a,t),n=i.createBufferSource();return n.buffer=e,n.connect(i.destination),n.start(0),i.startRendering()}async _processChannelRNN(e,t){const s=this._module,a=s._malloc(R*4),i=s._malloc(R*4),n=s._rnnoise_create(0),l=new Float32Array(e.length),r=a>>2,o=i>>2,d=Math.ceil(e.length/R);for(let h=0;h*R<e.length;h++){const u=h*R;for(let p=0;p<R;p++)s.HEAPF32[r+p]=(e[u+p]||0)*ne;s._rnnoise_process_frame(n,i,a);for(let p=0;p<R&&u+p<e.length;p++)l[u+p]=s.HEAPF32[o+p]/ne;h%80===79&&(t&&t((h+1)/d),await new Promise(p=>setTimeout(p,0)))}return s._rnnoise_destroy(n),s._free(a),s._free(i),l}async _processRNNoise(e,t,s){const a=e.sampleRate,i=e.numberOfChannels,n=await this._resample(e,ie,t),l=[];for(let o=0;o<i;o++){const d=n.getChannelData(o).slice(),h=await this._processChannelRNN(d,u=>s&&s((o+u)/i));l.push(h)}const r=t.createBuffer(i,n.length,ie);for(let o=0;o<i;o++)r.copyToChannel(l[o],o);return this._resample(r,a,t)}async _processWiener(e,t){const s=e.sampleRate,a=Math.min(Math.floor(.2*s),e.length),i=t.createBuffer(e.numberOfChannels,e.length,s);for(let n=0;n<e.numberOfChannels;n++){const l=e.getChannelData(n),r=i.getChannelData(n);r.set(l);let o=0;for(let h=0;h<a;h++)o+=r[h]*r[h];o/=a;const d=Math.sqrt(o)*2.5;for(let h=0;h<r.length;h++){const u=Math.abs(r[h]);r[h]*=Math.max(0,1-d/Math.max(u,1e-10))}}return i}_loadScript(e){return new Promise((t,s)=>{if(document.querySelector(`script[src="${e}"]`)){t();return}const a=document.createElement("script");a.src=e,a.onload=t,a.onerror=()=>s(new Error(`Failed to load ${e}`)),document.head.appendChild(a)})}}function U(c,e,t){for(let s=0;s<t.length;s++)c.setUint8(e+s,t.charCodeAt(s))}function H(c,e){const t=c.numberOfChannels,s=c.sampleRate,a=c.length,i=e===16?2:3,n=t*a*i,l=new ArrayBuffer(44+n),r=new DataView(l);U(r,0,"RIFF"),r.setUint32(4,36+n,!0),U(r,8,"WAVE"),U(r,12,"fmt "),r.setUint32(16,16,!0),r.setUint16(20,1,!0),r.setUint16(22,t,!0),r.setUint32(24,s,!0),r.setUint32(28,s*t*i,!0),r.setUint16(32,t*i,!0),r.setUint16(34,e,!0),U(r,36,"data"),r.setUint32(40,n,!0);let o=44;for(let d=0;d<a;d++)for(let h=0;h<t;h++){const u=Math.max(-1,Math.min(1,c.getChannelData(h)[d]));if(e===16)r.setInt16(o,Math.round(u*32767),!0),o+=2;else{const p=Math.round(u<0?u*8388608:u*8388607);r.setUint8(o,p&255),r.setUint8(o+1,p>>8&255),r.setUint8(o+2,p>>16&255),o+=3}}return new Blob([l],{type:"audio/wav"})}function W(c,e){const t=URL.createObjectURL(c),s=document.createElement("a");s.href=t,s.download=e,s.click(),setTimeout(()=>URL.revokeObjectURL(t),2e3)}const he="soniq_v10_state",N={sliders:{"eq-sub":0,"eq-bass":0,"eq-mid":0,"eq-highs":0,"eq-presence":0,"eq-air":0,"eq-demud":0,"comp-threshold":-18,"comp-ratio":4,"comp-attack":10,"comp-release":100,"stereo-width":100,"output-gain":0},toggles:{denoise:!1,limiter:!1,gate:!1}};function Ce(c,e){try{localStorage.setItem(c,JSON.stringify(e))}catch{}}function Pe(c){try{const e=localStorage.getItem(c);return e===null?null:JSON.parse(e)}catch{return null}}const z=["eq-sub","eq-bass","eq-mid","eq-highs","eq-presence","eq-air","eq-demud","comp-threshold","comp-ratio","comp-attack","comp-release","stereo-width","output-gain"],G=["denoise","limiter","gate"];class Fe{constructor(e,{denoise:t=null}={}){this._ae=e,this._denoise=t||new de,this._originalBuffer=null,this._masteredBuffer=null,this._currentFile=null,this._isPlaying=!1,this._playSource=null,this._playAnalyser=null,this._playStartTime=0,this._playOffset=0,this._abMode=!1,this._hasFile=!1,this._hasEnhanced=!1,this._seekWasPlaying=!1,this._liveEqNodes=null,this._rnnoiseApplied=!1,this._sliders={...N.sliders},this._toggles={...N.toggles},this._toggles.limiter=!0,this._activePreset=null,this._waveformBefore=new se("waveformBefore","#6c63ff"),this._waveformAfter=new se("waveformAfter","#00d4aa"),this._spectrum=new we("spectrum"),this._lufsMeter=new qe,this._seekbar=new Me(s=>this._onSeek(s)),this._presets=new Le((s,a)=>this._applyPreset(s,a)),this._resetBtns=new Ie((s,a)=>this._onReset(s,a)),this._el=null}render(){const e=document.createElement("div");return e.innerHTML=this._buildHTML(),this._el=e.firstElementChild,this._el}init(){var e,t,s;this._waveformBefore.clear(),this._waveformAfter.clear(),this._spectrum.clear(),this._seekbar.render({containerId:"masterSeekContainer",inputId:"masterSeek",curId:"masterSeekCur",durId:"masterSeekDur"}),this._presets.render(),this._resetBtns.addResetButtonById("resetMasterEQ","eq"),this._resetBtns.addResetButtonById("resetMasterComp","comp"),this._resetBtns.addResetButtonById("resetMasterOutput","output"),this._resetBtns.addResetButtonById("clearPresetBtn","preset"),(e=document.getElementById("resetDenoise"))==null||e.addEventListener("click",a=>{a.stopPropagation(),this._resetToggle("denoise",!1),this._resetBtns.showConfirmation(a.currentTarget)}),(t=document.getElementById("resetLimiter"))==null||t.addEventListener("click",a=>{a.stopPropagation(),this._resetToggle("limiter",!0),this._resetBtns.showConfirmation(a.currentTarget)}),(s=document.getElementById("resetGate"))==null||s.addEventListener("click",a=>{a.stopPropagation(),this._resetToggle("gate",!1),this._resetBtns.showConfirmation(a.currentTarget)}),this._initDropZone(),this._initSliders(),this._initToggles(),this._initActionBar(),this._initResetAll(),this._initKeyboard(),this._initResizeObserver(),this._updateActionBar(),this._initTooltips(),this._updateRNNoiseBadge("loading"),this._denoise.load().then(()=>this._updateRNNoiseBadge(null)).catch(()=>this._updateRNNoiseBadge("unavailable"))}loadState(e){e&&(e.sliders&&(Object.assign(this._sliders,e.sliders),z.forEach(t=>{const s=document.getElementById(t);s&&this._sliders[t]!==void 0&&(s.value=this._sliders[t],this._updateSliderDisplay(t,this._sliders[t]))})),e.toggles&&(Object.assign(this._toggles,e.toggles),G.forEach(t=>{const s=document.getElementById(`toggle-${t}`);s&&(s.classList.toggle("on",!!this._toggles[t]),s.setAttribute("aria-checked",String(!!this._toggles[t])))})),e.activePreset&&(this._activePreset=e.activePreset,this._presets.setActive(this._activePreset)),this._syncAudioEngine())}getState(){return{sliders:{...this._sliders},toggles:{...this._toggles},activePreset:this._activePreset}}_buildHTML(){return`
...
<div class="stem-master-panel" id="stemMasterPanel">
  ...
  <div class="stem-master-body">
    ...
    <div class="spectrum-wrap">
      ...
      <div class="exp-sl-row"><span class="exp-sl-lbl">Hi-Pass</span><input type="range" class="stem-slider" data-p="eq.hpf" min="20" max="500" step="5" value="${e.eq.hpf}" style="--stem-color:${t}"><span class="exp-sl-val" data-v="eq.hpf">${Oe(e.eq.hpf)}</span></div>
      <div class="exp-sl-row"><span class="exp-sl-lbl">Low Shelf</span><input type="range" class="stem-slider" data-p="eq.bass" min="-12" max="12" step=".5" value="${e.eq.bass}" style="--stem-color:${t}"><span class="exp-sl-val" data-v="eq.bass">${J(e.eq.bass)}</span></div>
      <div class="exp-sl-row"><span class="exp-sl-lbl">Presence</span><input type="range" class="stem-slider" data-p="eq.pres" min="-12" max="12" step=".5" value="${e.eq.pres}" style="--stem-color:${t}"><span class="exp-sl-val" data-v="eq.pres">${J(e.eq.pres)}</span></div>
      <div class="exp-sl-row"><span class="exp-sl-lbl">Hi Shelf</span><input type="range" class="stem-slider" data-p="eq.air" min="-12" max="12" step=".5" value="${e.eq.air}" style="--stem-color:${t}"><span class="exp-sl-val" data-v="eq.air">${J(e.eq.air)}</span></div>`,a=`
      ...
      <div class="exp-sl-row"><span class="exp-sl-lbl">Attack</span><input type="range" class="stem-slider" data-p="comp.atk" min=".1" max="200" step=".1" value="${e.comp.atk}" style="--stem-color:${t}"><span class="exp-sl-val" data-v="comp.atk">${le(e.comp.atk)}</span></div>
      <div class="exp-sl-row"><span class="exp-sl-lbl">Release</span><input type="range" class="stem-slider" data-p="comp.rel" min="10" max="1000" step="5" value="${e.comp.rel}" style="--stem-color:${t}"><span class="exp-sl-val" data-v="comp.rel">${le(e.comp.rel)}</span></div>`;return`
    <div class="track-hdr">
      <span class="t-icon">${De[e.type]}</span>
  ...
  `)}function Je(){Xe(),new ke().render(),new ye().render();const t=new _e,s=new Fe(t),a=s.render(),i=document.getElementById("tab-master");i.innerHTML="",i.appendChild(a),s.init(),s.loadState(Pe(he));const n=new Ke(t),l=n.render(),r=document.getElementById("tab-stem");r.innerHTML="",r.appendChild(l),n.init()}document.addEventListener("DOMContentLoaded",Je);
