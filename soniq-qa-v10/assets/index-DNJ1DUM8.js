  ...
  <div class="stem-master-body">
    ...
    <div class="track-hdr">
      ...
      <div class="track-name-col">
        ...
        <div class="track-file">${e.filename} · ${Ue(e.fileSize)}</div>
      </div>
