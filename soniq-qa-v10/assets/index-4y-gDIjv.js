...
<div class="stem-master-panel" id="stemMasterPanel">
  ...
  <div class="stem-master-body">
    ...
    <div class="spectrum-wrap">
      ...
      <div class="exp-sl-row"><span class="exp-sl-lbl">Hi-Pass</span><input type="range" class="stem-slider" data-p="eq.hpf" min="20" max="500" step="5" value="${e.eq.hpf}" style="--stem-color:${t}"><span class="exp-sl-val" data-v="eq.hpf">${Ne(e.eq.hpf)}</span></div>
      ...
      <div class="exp-sl-row"><span class="exp-sl-lbl">Ratio</span><input type="range" class="stem-slider" data-p="comp.rat" min="1" max="20" step=".5" value="${e.comp.rat}" style="--stem-color:${t}"><span class="exp-sl-val" data-v="comp.rat">${ze(e.comp.rat)}</span></div>
      <div class="exp-sl-row"><span class="exp-sl-lbl">Attack</span><input type="range" class="stem-slider" data-p="comp.atk" min=".1" max="200" step=".1" value="${e.comp.atk}" style="--stem-color:${t}"><span class="exp-sl-val" data-v="comp.atk">${re(e.comp.atk)}</span></div>
      <div class="exp-sl-row"><span class="exp-sl-lbl">Release</span><input type="range" class="stem-slider" data-p="comp.rel" min="10" max="1000" step="5" value="${e.comp.rel}" style="--stem-color:${t}"><span class="exp-sl-val" data-v="comp.rel">${re(e.comp.rel)}</span></div>`;return`
    <div class="track-hdr">
      <span class="t-icon">${Fe[e.type]}</span>
      <div class="track-name-col">
        <div class="track-name" style="color:${t}">${e.name}</div>
        <div class="track-file">${e.filename} · ${He(e.fileSize)}</div>
      </div>
    ...
    <div class="track-mix">
      ...
      <div class="mix-pan">
        ...
        <span class="pan-num" data-v="pan">${Oe(e.pan)}</span>
      </div>
  ...
  `)}function Ke(){Ze(),new ke().render(),new ye().render();const t=new _e,s=new Ce(t),a=s.render(),i=document.getElementById("tab-master");i.innerHTML="",i.appendChild(a),s.init();const n=new je(t),l=n.render(),r=document.getElementById("tab-stem");r.innerHTML="",r.appendChild(l),n.init()}document.addEventListener("DOMContentLoaded",Ke);
