...
<div class="stem-master-panel" id="stemMasterPanel">
  ...
  <div class="stem-master-body">
    ...
    <div class="spectrum-wrap">
      ...
      <div class="exp-sl-row"><span class="exp-sl-lbl">Hi-Pass</span><input type="range" class="stem-slider" data-p="eq.hpf" min="20" max="500" step="5" value="${e.eq.hpf}" style="--stem-color:${t}"><span class="exp-sl-val" data-v="eq.hpf">${$e(e.eq.hpf)}</span></div>
      ...
      <div class="exp-sl-row"><span class="exp-sl-lbl">Ratio</span><input type="range" class="stem-slider" data-p="comp.rat" min="1" max="20" step=".5" value="${e.comp.rat}" style="--stem-color:${t}"><span class="exp-sl-val" data-v="comp.rat">${Ne(e.comp.rat)}</span></div>
    ...
    <div class="track-hdr">
      <span class="t-icon">${Pe[e.type]}</span>
      <div class="track-name-col">
        <div class="track-name" style="color:${t}">${e.name}</div>
        <div class="track-file">${e.filename} · ${Oe(e.fileSize)}</div>
      </div>
    ...
    <div class="track-mix">
      ...
      <div class="mix-pan">
        ...
        <span class="pan-num" data-v="pan">${ze(e.pan)}</span>
      </div>
  ...
  `)}function Ze(){je(),new be().render(),new _e().render();const t=new ge,s=new Ae(t),a=s.render(),i=document.getElementById("tab-master");i.innerHTML="",i.appendChild(a),s.init();const n=new Ve(t),l=n.render(),r=document.getElementById("tab-stem");r.innerHTML="",r.appendChild(l),n.init()}document.addEventListener("DOMContentLoaded",Ze);
